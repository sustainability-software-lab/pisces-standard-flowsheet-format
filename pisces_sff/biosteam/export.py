...
def export_biosteam_flowsheet_sff(sys, file_path):
    ...
    # validate=False because the current export output predates schema alignment
    # (missing 'metadata' and 'utilities' top-level keys required by the schema)
    write_sff(flowsheet_to_export, file_path, validate=False)
