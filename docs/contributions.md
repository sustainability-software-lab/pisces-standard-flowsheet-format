...
* [Sarang Bhagwat](https://github.com/sarangbhagwat) (lead SFF author, developer, and maintainer; also led the development of the BioSTEAM SFF export software)
* [Corinne Scown](https://eta.lbl.gov/people/corinne-scown) (led efforts to found, develop, coordinate, and expand the software)
* [Tyler Huntington](https://github.com/tylerhuntington) (integrated the SFF with the [Project PISCES website](https://projectpisces.org/), helped build the documentation, and more)
