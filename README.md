...
The [Standard Flowsheet Format](https://sustainability-software-lab.github.io/pisces-standard-flowsheet-format/) is a JSON-based standard to represent chemical process flowsheets for interoperability across process simulators. Currently supports export from BioSTEAM. 
